import { Fee, PrivateProfile } from './../types';
import {
  bufferToBytes,
...
function sortObject(obj: any): any {
  ...
  /**
   * Encrypt private profile data
   *
   * @param   data - Private profile data
   *
   * @param   privateKey - Private key
   *
   * @returns Encrypted string
   */
export function encryptWithPrivatekey(data: PrivateProfile, privateKey: string): string {
   ...
   */
export function decryptWithPrivatekey(data: string, privateKey: string): PrivateProfile {
...
export function getPdvHeaders(data: any, wallet: Wallet) {
  let hash;
